...
function empInPostSummary() {
  ...
  obj.date = '20170622';//CTSI_API_JSON.time; // 20170525
  obj.post = '所有岗位';// 2017-5-25 18:04:28，领导让写死
  api('/panoramaView/empInPostSummary', 3001, 'cbEmpInPostSummary',
      JSON.stringify(obj));
}
...
function empInPostAbnormalCauseAnalysis() {
  var obj = getArea();
  obj.date = '20170622';//CTSI_API_JSON.time;
  api('/panoramaView/empInPostAbnormalCauseAnalysis', 3001,
      'cbEmpInPostAbnormalCauseAnalysis', JSON.stringify(obj));
}
...
function viewEmpDetailsCB(phone, post) {
  ...
  obj.post = post;
  obj.date = '20170622';//CTSI_API_JSON.time;
  api('/panoramaView/viewEmpDetails', 3001, 'cbViewEmpDetails',
      JSON.stringify(obj));
}
...
function taskPerformanceRanking() {
  ...
  api('/panoramaView/taskPerformanceRanking', 3001, 'cbTaskPerformanceRanking',
      JSON.stringify(obj));
}
...
function postInfoOverviewPng(widthHeight, level, latLng) {
  ...
  obj.level = level;
  obj.latLng = latLng;
  api('/panoramaView/postInfoOverviewPng', 3001, 'cbPostInfoOverviewPng',
      JSON.stringify(obj));
}
