...
function formDataDay(day) {
  potencyClick(getItem("getArea"), getItem("getArea1"), getItem("getPost"),
      day);
}
...
function empWorkEfficiencyIndex() {
  apiReq.post = null;
  api('/empEfficiency/empWorkEfficiencyIndex', 3001, 'cbEmpWorkEfficiencyIndex',
...
function empWorkEfficiencyMap() {
  ...
  api('/empEfficiency/empWorkEfficiencyMap', 3001, 'cbEmpWorkEfficiencyMap',
      JSON.stringify(apiReq));
}
...
function empWorkEfficiencyPercentage() {
  ...
  api('/empEfficiency/empWorkEfficiencyPercentage', 3001,
      'cbEmpWorkEfficiencyPercentage', JSON.stringify(apiReq));
}
...
function quadrantCoordinatePoint() {
  api('/empEfficiency/quadrantCoordinatePoint', 3001,
      'cbQuadrantCoordinatePoint', null);
}